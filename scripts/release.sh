...
echo "  - Publish to NPM as react-confetti-shooter@$NEW_VERSION"
echo "  - Create a GitHub release"
echo ""
print_status "Monitor the progress at:"
echo "  https://github.com/LynchzDEV/lynchz-confetti/actions"
echo ""
print_status "Once published, users can install with:"
echo "  npm install react-confetti-shooter@$NEW_VERSION"
echo "  bun add react-confetti-shooter@$NEW_VERSION"
